async function fMail(bot,msg,collection,chatId){
    try {
        // Find all documents with projection for chatId only
        const chatIds = await collection.find({gender:"female"}).project({ chatId: 1, _id: 0 }).toArray();
